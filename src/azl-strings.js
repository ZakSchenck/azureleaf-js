class Azureleaf {
  ...
  */
  truncate = (string, maxLength) => {
    ...
    if (typeof string !== "string" || string.length === 0 || typeof maxLength !== "number" || maxLength <= 0) return string;
  ...
  countOccurrences = (string, substring) => {
    if (typeof string !== "string" || string.length === 0) return string;
    else if (typeof substring !== "string" || string.length === 0) return substring;
...
console.log($azl.stringReverse("hello, hello, hello"));
